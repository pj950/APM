...
function App() {
  ...
  const isQuestioning = currentStage === 'QUESTIONING_TEST';
  ...
  const showGenerativeScene = currentStage !== 'QUESTIONING' && currentStage !== 'QUESTIONING_TEST' && currentStage !== 'RESULT' && (currentStage !== 'STANDBY' || !fluidModeActive) && currentStage !== 'GUMGUM_DEMO' && currentStage !== 'FACE_DEMO';
